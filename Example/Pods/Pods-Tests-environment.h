...
#define COCOAPODS_POD_AVAILABLE_NPKeyboardLayoutGuide
#define COCOAPODS_VERSION_MAJOR_NPKeyboardLayoutGuide 1
#define COCOAPODS_VERSION_MINOR_NPKeyboardLayoutGuide 0
#define COCOAPODS_VERSION_PATCH_NPKeyboardLayoutGuide 0
